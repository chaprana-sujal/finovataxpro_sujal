      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><a href="/services/private-limited-company" className="hover:text-white transition">Company Registration</a></li>
              <li><a href="/services/gst-registration" className="hover:text-white transition">GST Registration</a></li>
              <li><a href="/services/itr-filing" className="hover:text-white transition">Income Tax Filing</a></li>
              <li><a href="/services/trademark-registration" className="hover:text-white transition">Trademark Registration</a></li>
              <li><a href="/services/roc-annual-filing" className="hover:text-white transition">Annual Compliance</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center text-sm text-gray-400">
            <p>© 2024 FinovaTaxPro. All rights reserved.</p>
